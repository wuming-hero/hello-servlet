...
%>
<% String str1=new String(request.getParameter("hobby").getBytes("iso-8859-1"),"utf-8"); 
	request.setAttribute("str1", str1);	
%>
	姓名:<input type="text" name="name" value="${str}<%-- <%=new String(request.getParameter("name").getBytes("ISO-8859-1"),"UTF-8")%> --%>"><br/>
